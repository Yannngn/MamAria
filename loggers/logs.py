...
def log_predictions(data, label, predictions, global_metrics, label_metrics, step, epoch, time=0, folder=CONFIG.PATHS.PREDICTIONS_DIR):
    ...
    save_predictions_as_imgs(data, label, predictions, step, epoch, dict_eval, time=time, folder=folder)
